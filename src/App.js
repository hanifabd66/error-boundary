...
//   // }
//   // if (cards.length > 5) buttonStyle.backgroundColor = 'blue'
//   // if (cards.length < 5) buttonStyle.backgroundColor = 'pink'

//   // dynamic style with class
//   const classes = ['button']
//   if (cards.length > 5) classes.push('blue')
//   if (cards.length < 5) classes.push('pink')

//   // fungsi delete
//   const deleteCardHandler = (id) => {
//     const cards_copy = [...cards]
//     // splice fungsi array untuk hapus
...
//     // separate operator
//     const cards_copy = [...cards]
//     // 3. change name of the spesific card
//     cards_copy[cardIndex].name = event.target.value
//     // 4. update card
//     setCards(cards_copy)
//   }

//   const changeAgehandler = (event, id) => {
//     const cardIndex = cards.findIndex(card => card.id === id)
//     // separate operator [...cards]
//     const cards_copy = [...cards]
...
//         changeAge={(event) => changeAgehandler(event, card.id)}
...
//   return (
//     <div className="App">
//       <button className={classes.join(' ')} onClick={toggleButton}>Show/Hide</button>
//       {/* <InputName nameComp={this.name} changeName={this.changeNameHandler} /> */}
...
// import BuggyCounter from './componen/BuggyCounter'
...
//   handleSubmit = () => {
//     if (this.state.name === '' || this.state.address === '', this.state.number === '') {
//       alert('all form is required, cant be empty!')
//     }
//     if (this.state.name.length < 5 || this.state.address.length < 5 || this.state.address.length < 5) {
//       alert('please type more than 5 words!')
//     }
//     else if (this.state.number >= 8 && this.state.number <= 12) {
//       alert('number must be between 8-12!')
//     }
//     else {
//       alert(`welcome, ${this.state.name} youre already registered `)
//     }
//     // alert('hai')
...
//   render() {
//     const disabled = this.state.name.length < 5 || this.state.address.length < 5 || this.state.number.length < 8 || this.state.number.length > 12 ? true : false
//     return (
//       <div >
//         <h1>Registration Form</h1> <hr />
//         <InputName nameComp={this.state.name} changeName={this.changeNameHandler} /> <br /> <br />
//         <InputAddress addressComp={this.state.address} changeAddress={this.changeAddressHandler} /> <br /> <br />
//         <InputNumber numberComp={this.state.number} changeNumber={this.changeNumberHandler} />  <br /> <br />
...
import './App.css';
import BuggyCounter from './componen/BuggyCounter'
import ConditionalComponent from './componen/ConditionalComponent'
import ErrorBoundary from './componen/ErrorBoundary'
